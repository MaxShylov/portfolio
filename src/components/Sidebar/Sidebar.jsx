...
const MENU = [
  { key: 1, path: ROUTERS.INDEX },
  { key: 2, path: ROUTERS.PORTFOLIO.INDEX },
  { key: 3, path: ROUTERS.CONTACTS },
  { key: 4, path: ROUTERS.PORTFOLIO.DEEPMED },
  { key: 5, path: ROUTERS.PORTFOLIO.SSP },
  { key: 6, path: ROUTERS.PORTFOLIO.TODO_LIST_GQL },
  { key: 7, path: ROUTERS.PORTFOLIO.BT_DEBTS },
  { key: 8, path: ROUTERS.PORTFOLIO.OSCE }
];
...
class Sidebar extends Component {
  ...
  toggleMenu = () => {
    const
      ...
      isPortfolioIndex = pathname === ROUTERS.PORTFOLIO.INDEX;
